      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button  size="mini" round type="primary" icon="el-icon-check" @click="openeditwin1(scope.row.payId)">登记</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
      ...
      <div>
        <el-form  size="small" :inline="true" v-model="scellform">
          <el-row>
            ...
            <el-col :span="18"><h3>出库单登记</h3></el-col>
            <el-col :span="3">
    ...
    export default {
      ...
      methods: {
        ...
        addSCll(){
          ...
          this.$axios.post("SPay/addOutInStorage.May",JSON.stringify(newArr),
